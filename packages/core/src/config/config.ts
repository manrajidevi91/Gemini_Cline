...
export class Config implements McpContext, AgentLoopContext {
  ...
  private readonly interactiveApproval: boolean;
  ...
  constructor(params: ConfigParameters) {
    ...
    this.interactiveApproval = params.interactiveApproval ?? false;
  ...
  private async _initialize(): Promise<void> {
    ...
    await this.teamRegistry.loadTeams();
  ...
  getGlobalTeamsDir(): string {
    return Storage.getUserTeamsDir();
  }
  ...
  setCurrentTeam(teamName: string | undefined): void {
  ...
  getInteractiveApproval(): boolean {
    return this.interactiveApproval;
  }
