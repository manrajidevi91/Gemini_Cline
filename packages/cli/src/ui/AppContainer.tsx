...
export const AppContainer = (props: AppContainerProps) => {
  ...
  const openTeamSelector = useCallback(() => setIsTeamSelectorOpen(true), []);
  const closeTeamSelector = useCallback(() => setIsTeamSelectorOpen(false), []);
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Show Team Selector if teams are available and this is a new session
      if (!resumedSessionData && config.getTeamRegistry().getAllDefinitions().length > 0) {
