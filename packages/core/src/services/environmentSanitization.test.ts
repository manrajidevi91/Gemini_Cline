...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe
      STRIPE_SK_LIVE: 'stripe_sk_live_placeholder',
      STRIPE_RK_LIVE: 'stripe_rk_live_placeholder',
      STRIPE_SK_TEST: 'stripe_sk_test_placeholder',
      STRIPE_RK_TEST: 'stripe_rk_test_placeholder',
      // Slack
