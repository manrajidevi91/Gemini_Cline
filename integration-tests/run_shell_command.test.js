...
function getAllowedListCommand() {
  switch (shell) {
    case 'powershell':
...
function getDisallowedFileReadCommand(testFile) {
...
function getChainedEchoCommand() {
...
//# sourceMappingURL=run_shell_command.test.js.map
