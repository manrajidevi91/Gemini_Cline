...
/**
 * Defines the orchestration mode for an agent team.
 */
...
export interface TeamDefinition {
  ...
  displayName?: string;
  /** Description of the team's purpose and member roles. */
  description: string;
  /** The name of the agent that leads the team. */
  leadAgent: string;
  /** Names of other agents belonging to this team. */
  members: string[];
  /** Optional custom orchestration instructions for the lead agent. */
  orchestrationPrompt?: string;
  /** The mode of orchestration to use for this team. */
