 ...
 */
async function expectSubagentCall(rig, agentName) {
  await rig.expectToolCallSuccess([AGENT_TOOL_NAME], undefined, (args) => {
    try {
 ...
 */
function isSubagentCalled(toolLogs, agentName) {
...
function readProjectFile(rig, relativePath) {
...
//# sourceMappingURL=subagents.eval.js.map
